...
$(function () {
  ...
  var dtUserTable = $('.user-list-tables')
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ...
      buttons: [
        ...
        //     window.location.href = 'admin/client/add';
        //     $(node).removeClass('btn-secondary')
        //   }
        // }
      ],
      ...
      initComplete: function () {
        ...
        //   .every(function () {
        //     var column = this
        //     var label = $('<label class="form-label" for="FilterTransaction">Status</label>').appendTo('.is_active')
        //     var select = $(
