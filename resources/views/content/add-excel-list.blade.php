...
@section('title', 'Add Client Using Excel Sheet')
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <h3 class="submit-property__headline">Excel Sheet Uploade </h3>
                                        ...
                                        <div class="panel-body card-body">
                                            ...
                                            <form class="form" action="{{ route('add-uploadexcelfile') }}" enctype="multipart/form-data" id="image-upload" method="POST">
                                                @csrf
                                                <div class="mb-3">

                                                    <input type="file" name="excel_file" class="form-control mb-1" id="file" onchange="return fileValidation()"
                                                         required autocomplete="off" />
                                                            <span id="fileError" style="color: red"></span><span class="text-danger" id="image-input-error"></span>
...
<script type="text/javascript">
    ...
    function fileValidation() {
            ...
            if (!allowedExtensions.exec(filePath)) {
                $("#fileError").html("Only CSV File Type Are Allowed.");
                fileInput.value = '';
                return false;
            }
        }
